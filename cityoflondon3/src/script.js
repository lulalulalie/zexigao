...
mapboxgl.accessToken = "pk.eyJ1IjoiZ2FvemV4aTEyMzQiLCJhIjoiY201d2pvOWF4MDNkZzJqc2dmcGMyajNxeCJ9.6Z0L0-7fMff-5dJxanREZg";
...
const data_url =
"https://api.mapbox.com/datasets/v1/gaozexi1234/cm6gobl366nts1nry2v2k2dpr/features?access_token=pk.eyJ1IjoiZ2FvemV4aTEyMzQiLCJhIjoiY201d2pvOWF4MDNkZzJqc2dmcGMyajNxeCJ9.6Z0L0-7fMff-5dJxanREZg";
map.on('load', () => {
 map.addLayer({
 id: 'crimes',
 type: 'circle',
